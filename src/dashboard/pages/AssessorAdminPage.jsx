...
// Admin management of 3PIC assessor ↔ award-category assignments. Mirrors the reviewer page, but
// scopes who scores (not who validates). An assessor only sees and scores entries in their categories.
      ...
      <div className="dash-page-head">
        <div>
          ...
          <p className="dash-sub">
            ...
            per category so the majority tally is meaningful.
          </p>
        </div>
      </div>
              ...
              <div key={r.userId} className="dash-card ra-card">
                <div className="ra-head">
                  ...
                  <span className="ra-roles">
                    {roles.map((role) => (<span key={role} className="ra-role">{role}</span>))}
                  </span>
                  {!isEditing && (
                ...
                {isEditing ? (
                  <div className="ra-editor">
                    ...
                    <div className="ra-actions">
                      ...
                      <button type="button" className="dash-btn is-ghost" onClick={() => setEditing(null)} disabled={saving}>Cancel</button>
                  ...
                  <div className="ra-chips">
                    {r.categoryNumbers.length === 0 ? (
                      <span className="ra-empty"><i className="fas fa-circle-info" aria-hidden="true" /> No categories assigned — this assessor sees an empty queue.</span>
                    ) : (
